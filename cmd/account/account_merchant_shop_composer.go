...
var accountCompanyMerchantShopComposerCmd = &cobra.Command{
	...
	Short: "Configure local composer.json to use packages.allincart.net",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := os.Stat("composer.json"); err == nil {
			...
			if !composerJson.Repositories.HasRepository("https://packages.allincart.net") {
			...
			composerAuth.BearerAuth["packages.allincart.net"] = token
