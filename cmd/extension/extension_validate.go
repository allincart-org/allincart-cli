...
var extensionValidateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// If the user does not want to run full validation, only run allincart-cli
		if !isFull {
			only = "sw-cli"
		}
...
func init() {
	...
	extensionValidateCmd.PersistentFlags().String("check-against", "highest", "Check against Allincart Version (highest, lowest)")
