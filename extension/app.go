...
func (a App) GetAllincartVersionConstraint() (*version.Constraints, error) {
	if a.config != nil && a.config.Build.AllincartVersionConstraint != "" {
		v, err := version.NewConstraint(a.config.Build.AllincartVersionConstraint)
		if err != nil {
			return nil, err
		}
