...
<manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/allincart/allincart/trunk/src/Core/Framework/App/Manifest/Schema/manifest-2.0.xsd">
	<meta>
...
func TestNoCompatibilityGiven(t *testing.T) {
	...
	compatibility, err := app.GetAllincartVersionConstraint()
	assert.NoError(t, err)
