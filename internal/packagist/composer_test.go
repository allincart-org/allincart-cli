...
func TestComposerJsonRepositoriesHasRepository(t *testing.T) {
	repos := ComposerJsonRepositories{
		{
			Type: "vcs",
			URL:  "https://github.com/allincart/platform",
		},
		{
			Type: "composer",
	...
	assert.True(t, repos.HasRepository("https://github.com/allincart/platform"))
	assert.True(t, repos.HasRepository("https://packages.example.org"))
	assert.False(t, repos.HasRepository("https://github.com/allincart/core"))
...
func TestComposerJsonSave(t *testing.T) {
	...
	composer := &ComposerJson{
		path:        composerFile,
		Name:        "allincart/cli",
		Description: "Allincart CLI tool",
		Version:     "1.0.0",
		Type:        "library",
		License:     "MIT",
...
func TestReadComposerJson(t *testing.T) {
	...
	t.Run("valid file", func(t *testing.T) {
		...
		assert.Equal(t, "allincart/cli", composer.Name)
		assert.Equal(t, "Allincart CLI tool", composer.Description)
		...
		assert.Equal(t, "https://github.com/allincart/platform", composer.Repositories[0].URL)
	})
...
`
		...
		expectedRepos := []ComposerJsonRepository{
			{Type: "vcs", URL: "https://github.com/allincart/platform"},
