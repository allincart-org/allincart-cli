...
func generateProjectSchema() error {
	...
	if err := r.AddGoComments("github.com/allincart-org/allincart-cli", "./shop"); err != nil {
		return err
	}
	...
	if err := os.WriteFile("shop/allincart-project-schema.json", bytes, 0o644); err != nil {
		return err
	}
...
func generateExtensionSchema() error {
	...
	if err := r.AddGoComments("github.com/allincart-org/allincart-cli", "./extension"); err != nil {
		return err
	}

	if err := r.AddGoComments("github.com/allincart-org/allincart-cli", "./internal/changelog"); err != nil {
		return err
	}
	...
	if err := os.WriteFile("extension/allincart-extension-schema.json", bytes, 0o644); err != nil {
		return err
	}
