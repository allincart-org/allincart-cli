...
import (
	...
	"github.com/allincart/allincart-cli/internal/changelog"
...
func generateProjectSchema() error {
	...
	if err := r.AddGoComments("github.com/allincart/allincart-cli", "./shop"); err != nil {
		return err
	}
...
func generateExtensionSchema() error {
	...
	if err := r.AddGoComments("github.com/allincart/allincart-cli", "./extension"); err != nil {
		return err
	}

	if err := r.AddGoComments("github.com/allincart/allincart-cli", "./internal/changelog"); err != nil {
		return err
	}
